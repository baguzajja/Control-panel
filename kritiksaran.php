...
<head>
	...
	<script type="text/javascript">
		var count_help = <?=$total_new[0];?>, count_kritik = <?=$total_new[1];?>, count_laporan = <?=$total_new[2];?>, client_id = '<?=$id;?>', grup = 1;
	</script>
</head>
<body>
	<!-- Fixed navbar -->
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="kritiksaran.php">Kritik &amp; Saran <?php if($total_new[1] > 0) echo '<span class="badge">'.$total_new[1].'</span>'; ?></a></li>
				<li class=""><a href="laporan.php" class="last-child">Laporan <?php if($total_new[2] > 0) echo '<span class="badge">'.$total_new[2].'</span>'; ?></a></li>
			</ul>
		...
		<!-- <div class="container"> -->
			...
			<div class="content-body">
				<div class="sidebar">
					...
					<span class="total"><?=$total[1] ?> Total kritik &amp; saran (<?=$total_new[1] ?> kritik &amp; saran baru)</span>
					<ul class="sidebar-help">
					<?php
					$pengaduan = get_list_pengaduan(1);
					...
					<div class="help-messages col-md-9">
						<div class="message-wrapper">
							...
							<ul>
								...
								<?php
								foreach (get_pengaduan($id, 1) as $key => $value) {
							...
							?>
							<h3>Silahkan pilih kritik &amp; saran terlebih dahulu</h3>
							<?php
							}
							?>
						</div>

...
<head>
	...
	<script type="text/javascript">
		var count_help = <?=$total_new[0];?>, count_kritik = <?=$total_new[1];?>, count_laporan = <?=$total_new[2];?>, client_id = '<?=$id;?>', grup = 0;
	</script>
</head>
<body>
	<!-- Fixed navbar -->
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li class="active"><a href="index.php">Help! <?php if($total_new[0] > 0) echo '<span class="badge danger">'.$total_new[0].'</span>'; ?></a></li>
				<li><a href="kritiksaran.php">Kritik &amp; Saran <?php if($total_new[1] > 0) echo '<span class="badge">'.$total_new[1].'</span>'; ?></a></li>
				<li><a href="laporan.php" class="last-child">Laporan <?php if($total_new[2] > 0) echo '<span class="badge">'.$total_new[2].'</span>'; ?></a></li>
			</ul>
		...
		<!-- <div class="container"> -->
			...
			<div class="content-body">
				<div class="sidebar">
					...
					<span class="total"><?=$total[0] ?> Total pengaduan (<?=$total_new[0] ?> Pengaduan baru)</span>
					<ul class="sidebar-help">
					<?php
					$pengaduan = get_list_pengaduan(0);
					...
					?>
						<li id="room-0<?=$value['client_id']?>" class="<?=$li_status ?>">
					...
					<!-- 	<li class="active">
							<a href="#">
								<span class="preview"> Tolong! Rumah saya kemalin...</span>
								<span class="author">Aidil Santoso - 13/09/15 00:59</span>
							</a>
						</li>
						<li class="new">
							<a href="#">
								<span class="preview"> Siang, pak. Motor saya hil...<span>
								<span class="author">Arya Sena - 13/09/15 00:59</span>
								<span class="alert-btn">new</span>
							</a>
						</li>
						<li class="new">
							<a href="#">
								<span class="preview"> Pak Tolong, dompet saya h...</span>
								<span class="author">Sutrisno - 13/09/15 00:59</span>
								<span class="alert-btn">new</span>
							</a>
						</li>
						<li class="new">
							<a href="#">
								<span class="preview"> Pak ada jasad tak bernyaw...</span>
								<span class="author">Heru Nurwasito - 13/09/15 00:59</span>
								<span class="alert-btn">new</span>
							</a>
						</li>
						<li class="new">
							<a href="#">
								<span class="preview"> Telah terjadi Pembunuhan ...</span>
								<span class="author">Himawat A - 13/09/15 00:59</span>
								<span class="alert-btn">new</span>
							</a>
						</li>
						<li>
							<a href="#">
								<span class="preview"> Ada bentrokan antar warga...</span>
								<span class="author">John Newman - 13/09/15 00:59</span>
							</a>
						</li>
						<li>
							<a href="#">
								<span class="preview"> Tolong, anak saya hilang di...</span>
								<span class="author">Miley Cyrus - 13/09/15 00:59</span>
							</a>
						</li>
						<li>
							<a href="#">
								<span class="preview"> Terima kasih, saya sudah aman.</span>
								<span class="author">Alex Turner - 13/09/15 00:59</span>
							</a>
						</li>
						<li>
							<a href="#">
						...
						<!-- <li>
							<a href="#">
								<span class="preview"> Lorem ipsum dolor sit amet...</span>
								<span class="author">Muhammad R Ridho - 13/09/15 00:59</span>
							</a>
						</li>
						<li>
							<a href="#">
					...
					<div class="help-messages col-md-9">
						<div class="message-wrapper">
							...
							<ul>
								...
								<?php
								foreach (get_pengaduan($id, 0) as $key => $value) {
							...
							?>
							<h3>Silahkan pilih pengaduan terlebih dahulu</h3>
							<?php
							}
							?>
						</div>
